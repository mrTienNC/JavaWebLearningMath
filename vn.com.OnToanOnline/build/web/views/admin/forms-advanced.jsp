<%-- 
    ...
    Created on : Mar 12, 2018, 5:17:03 PM
    Author     : TienNguyen
--%>
        ...
        <aside id="left-panel" class="left-panel">
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Admin"><!-- <img src="images/logo.png" alt="Logo"> -->Admin</a>
                    <a class="navbar-brand hidden" href="Admin"><!-- <img src="images/logo2.png" alt="Logo"> -->Admin</a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children active dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="menu-icon fa fa-th"></i><a href="<%=request.getContextPath()%>/AdminFormAdvanced">Advanced Form</a></li>
                            </ul>
                        </li>
