<%-- 
    Document   : admin-menu
    Created on : Mar 13, 2018, 2:46:46 PM
    Author     : TienNguyen
--%>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-table"></i><a href="<%=request.getContextPath()%>/AdminTableQuestion">Câu Hỏi</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-th"></i><a href="<%=request.getContextPath()%>/AdminTableMember">Người Dùng</a></li>
                                <li><i class="menu-icon fa fa-th"></i><a href="<%=request.getContextPath()%>/AdminTableQuestion">Câu Hỏi</a></li>
                            </ul>
                        </li>
