<%-- 
    ...
    Created on : Mar 12, 2018, 5:50:35 PM
    Author     : TienNguyen
--%>
...
<html>
    ...
    <body>
        ...
        <!--  flot-chart js -->
        <script src="<c:url value='./assets/js/lib/flot-chart/excanvas.min.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/jquery.flot.js'/>"></script>
        <script src="<c:url value ='./assets/js/lib/flot-chart/jquery.flot.pie.js'/>"></script>
        <script src="<c:url value = './assets/js/lib/flot-chart/jquery.flot.time.js'/>"></script>
        <script src="<c:url value = './assets/js/lib/flot-chart/jquery.flot.stack.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/jquery.flot.resize.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/jquery.flot.crosshair.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/curvedLines.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/flot-tooltip/jquery.flot.tooltip.min.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/flot-chart/flot-chart-init.js'/>"></script>
    </body>
</html>
