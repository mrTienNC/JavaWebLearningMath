<%-- 
    Document   : maps-gmap
    Created on : Mar 12, 2018, 5:59:02 PM
    Author     : TienNguyen
--%>
...
<html>
    ...
    <body>
        ...
        <!-- Gmaps -->
        <script src="<c:url value='./https://maps.googleapis.com/maps/api/js?v=3&sensor=false'/>"></script>
        <script src="<c:url value='./https://maps.googleapis.com/maps/api/js?key=AIzaSyD2jlT6C_to6X1mMvR9yRWeRvpIgTXgddM'/>"></script>
        <script src="<c:url value='./assets/js/lib/gmap/gmaps.js'/>"></script>
        <script src="<c:url value='./assets/js/lib/gmap/gmap.init.js'/>"></script>
    </body>
</html>
