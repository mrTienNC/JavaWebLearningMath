<%-- 
    Document   : charts-peity
    Created on : Mar 12, 2018, 5:54:48 PM
    Author     : TienNguyen
--%>
...
<html>
    ...
    <body>
        ...
        <script src="<c:url value='./assets/js/lib/peitychart/jquery.peity.min.js'/>"></script>
        <!-- scripit init-->
        <script src="<c:url value='./assets/js/lib/peitychart/peitychart.init.js'/>"></script>
        <!-- scripit init-->
    </body>
</html>
